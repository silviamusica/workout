...
var STR = {
  ...
  "Glutei": { d: "Figura a 4 (piriforme)", h: "Sdraiata supina, incrocia una caviglia sul ginocchio opposto formando un 4. Afferra con entrambe le mani la coscia della gamba che sta a terra e tirala verso il petto. Sentirai un allungamento profondo nel gluteo della gamba incrociata. Se non arrivi con le mani, usa un asciugamano.", t: "30s per lato, ripeti 2 volte", lk: "https://www.youtube.com/results?search_query=figure+four+piriformis+stretch", tm: 30 },
...
var DAYS = [
  { name: "Lunedi", focus: "Tirata upper + core + catena posteriore", dur: "8-10min", tEst: 70,
    ...
    ex: [
      ...
      { n: "Rematore Manubri", s: "4x12-10-8-8", rpe: "9", note: "Sost. pulley. Sett.1: 35-35-40-40", v2: { n: "Rematore Bilanciere", s: "4x12-10-8-8" }, v3: { n: "Rematore Manubri", s: "4x8-6-6-5", note: "Pesante" }, v4: { n: "Pendlay Row", s: "4x8-6-6-5" } },
  ...
  { name: "Martedi", focus: "Spinta lower + upper + braccia", dur: "8-10min", tEst: 80,
    ...
    ex: [
      ...
      { n: "Trazioni Supine", s: "4x12-10-8-8", rpe: "9", note: "Sost. lat machine. Sett.1: 30-30-35-35", v2: { n: "Rematore Bilanciere", s: "4x10-8-8-6" }, v3: { n: "Rematore Manubri", s: "4x10-8-8-6" }, v4: { n: "Trazioni Supine", s: "4xmax", note: "Negativa 5s" } },
      ...
      { n: "Dip su Panca", s: "3x12", rpe: "8", note: "Sost. tricipiti cavo", v2: { n: "Push-Up Diamante", s: "3xmax" }, v3: { n: "Dip su Panca", s: "3xmax", note: "Piedi su rialzo" }, v4: { n: "Dip su Panca", s: "3xmax", note: "Disco sulle gambe" } },
    ...
    return (
      <div onClick={function() { setExInfoOpen(null); }} style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.6)", zIndex: 250, display: "flex", alignItems: "center", justifyContent: "center", padding: 16 }}>
        <div onClick={function(e) { e.stopPropagation(); }} style={{ background: T.cd, borderRadius: 16, padding: 20, maxWidth: 420, width: "100%", color: T.tx, maxHeight: "80vh", overflowY: "auto" }}>
          ...
          {EX_IMG[exInfoOpen] && <img src={EX_IMG[exInfoOpen]} style={{ width: "100%", borderRadius: 10, marginBottom: 12 }} />}
            ...
            {dayData.ex.map(function(rawEx, i) {
              ...
              return <div key={i} style={{ borderBottom: "1px solid " + T.bg }}>
                ...
                {isX && db && <div style={{ padding: "0 14px 14px" }}>
                  ...
                  {showImg === "ex" + i && EX_IMG[ex.n] && <img src={EX_IMG[ex.n]} style={{ width: "100%", borderRadius: 8, marginBottom: 8 }} />}
